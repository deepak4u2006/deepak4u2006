...
`Swift` · `SwiftUI` · `SwiftData` · `async/await` · `XCTest` · SPM modules · on-device ML · KMP (shared domain)

---

*Portfolio projects are fintech-inspired learning demos — not affiliated with any bank or fintech company.*
